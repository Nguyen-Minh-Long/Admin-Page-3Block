...
function appendData(data, length) {
    ...
    for (var i = 0; i < data.length; i++) {
        ...
        text += "<td><a href='#' class='edit' data-toggle='modal'>" +
...
function destroy(urldestroy) {
    //API Real Delete
    fetch(
        "https://api3blockserver.herokuapp.com/user/gray/system/3block/realDeleteGray",
        {
            method: "DELETE",
            headers: {
...
function restore(urlrestore) {
    //API Restore
    fetch(
        "https://api3blockserver.herokuapp.com/user/gray/system/3block/restoreGray",
        {
            method: "PATCH",
            headers: {
                "Content-Type": "application/json",
