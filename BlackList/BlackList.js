...
function addURL() {
    ...
    if (validURL(newurl)) {
        ...
        // API Create New URL
        fetch(
            "https://api3blockserver.herokuapp.com/db/api/system/3block/createBlackList",
            {
                method: "POST",
                headers: {
...
function deleted(urldelete) {
    //API Soft Delete
    fetch(
        "https://api3blockserver.herokuapp.com/db/api/system/3block/softDeleteBlack",
        {
            method: "DELETE",
            headers: {
                "Content-Type": "application/json",
...
function TrashPage() {
    ...
    //API Trash BlackList
    fetch(
        "https://api3blockserver.herokuapp.com/db/api/system/3block/getBlackTrash",
        {
            method: "GET",
            headers: {
                "Content-Type": "application/json",
